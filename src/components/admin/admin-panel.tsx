...
interface Job { id: string; role_title: string; company: string; referral_type: string; job_url: string | null; created_at: string; approval_status: string; admin_feedback: string | null; url_verification_status: string; url_verification_feedback: string | null; employee: { full_name: string; email: string } | null }
interface VerificationReview { id: string; full_name: string | null; email: string; work_email: string | null; work_email_verified_at: string | null; company: string | null; designation: string | null; ai_verification_status: string; verification_score: number | null; verification_feedback: string | null; documentUrl: string | null }
